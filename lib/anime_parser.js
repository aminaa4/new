...
// Define the selector for the first and second elements
    const primarySelector = 'body > div:nth-of-type(2) > div:nth-of-type(4) > main > div > section:nth-of-type(4) > div > div > div:nth-of-type(2) > ul > li > div > a:nth-of-type(1)';
    const fallbackSelector = 'body > div:nth-of-type(2) > div:nth-of-type(4) > main > div > section:nth-of-type(3) > div > div > div:nth-of-type(2) > ul > li > div > a:nth-of-type(1)';
