...
export const scrapeAnimeDetails = async ({ id }) => {
  try {
    ...
    const studio = $('html > body > div:nth-of-type(2) > div:nth-of-type(4) > main > div > section:first-of-type > div > div > div > div:nth-of-type(2) > div:nth-of-type(6) > div > table > tbody > tr:nth-of-type(3) > td:nth-of-type(2) > a').text().replace(/\n/g, '').trim();
