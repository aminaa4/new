...
export const scrapeAnimeDetails = async ({ id }) => {
  try {
    ...
    const studio = $('html > body > div:nth-of-type(2) > div:nth-of-type(4) > main > div > section:first-of-type > div > div > div > div:first-of-type > div:nth-of-type(2) > div > table > tbody > tr:nth-of-type(3) > td:nth-of-type(2) > a:first-of-type').text().replace(/\n/g, '').trim();
    const studioUrl = $('html > body > div:nth-of-type(2) > div:nth-of-type(4) > main > div > section:first-of-type > div > div > div > div:first-of-type > div:nth-of-type(2) > div > table > tbody > tr:nth-of-type(3) > td:nth-of-type(2) > a:first-of-type').attr('href').replace('https://anime3rb.com/c/studio/','')
